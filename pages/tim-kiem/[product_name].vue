<template>
    <div class="flex flex-col space-y-20 justify-between items-center">
      ...
      >
      <h1 class="text-2xl font-medium p-5">Có {{ data.productList.length }} Sản Phẩm</h1>
      ...
      <UContainer v-else class="h-[300px]">
        <div class="flex flex-col justify-center items-center mt-10">
          <UHeading level="h2" class="text-center text-xl font-medium">
